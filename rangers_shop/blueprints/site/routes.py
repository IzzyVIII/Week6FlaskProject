...
def shop():
    ...
    shop_stats = {
        ...
        'sales' : sum([order.order_total for order in allorders]),  #[ 27.99, 83.25, 50.99 ] sum them bad boys up #looping through allorders list, order is each object and im grabbing the order_total & summing them all up
